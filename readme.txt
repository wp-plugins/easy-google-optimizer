...
== Installation ==
   ...
   1. Unzip and upload the folder into your `/wp-content/plugins/` directory
   2. Activate the plugin through the 'Plugins' menu in WordPress
   3. Follow the setup instructions to setup a Google Web Optimizer Optimizer test at www.google.com/intl/en/websiteoptimizer/tutorials.html
